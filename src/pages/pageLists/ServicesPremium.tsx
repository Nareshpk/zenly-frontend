                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 rounded-lg border border-gray-200 w-64 md:w-80 focus:outline-none focus:ring-2 focus:ring-indigo-100"
                        />
            ...
            <div className="mb-6 flex flex-wrap gap-2">
                {categories.map((c) => (
                    <button
                        ...
                        className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium transition ${activeCategory === c
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filtered.map((s: any, idx) => (
                    <motion.article
                        ...
                        className="group bg-white rounded-2xl overflow-hidden shadow relative cursor-pointer"
