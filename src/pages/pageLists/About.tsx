...
export default function AboutPremium() {
  return (
    <div className="w-full bg-gradient-to-b from-[#F6F8FF] to-white">
      {/* HERO - full bleed background, centered content */}
      <header className="relative overflow-hidden w-full">
        <div className="w-full px-4 py-16 md:py-20 lg:py-28">
          <div className="w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center px-4 sm:px-6 lg:px-8">
            <div className="lg:col-span-7">
              <motion.h1
                initial={{ y: 8, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.5 }}
                className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#231F53] leading-tight"
              >
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  href="/services"
                  className="inline-flex items-center gap-3 bg-[#231F53] text-white px-5 py-3 rounded-lg shadow-md hover:scale-[0.996] transition"
                >
                  Explore Services
                ...
                <a
                  href="/contact"
                  className="inline-flex items-center gap-3 bg-white border border-gray-200 px-5 py-3 rounded-lg text-gray-800 hover:shadow-sm transition"
                >
                  Book Appointment
                </a>
              </div>
            ...
            <div className="lg:col-span-5 relative">
              {/* Illustration / image placeholder - responsive heights */}
              <div className="rounded-3xl overflow-hidden shadow-xl">
                <img
                  src="https://static.vecteezy.com/system/resources/thumbnails/023/740/386/small/medicine-doctor-with-stethoscope-in-hand-on-hospital-background-medical-technology-healthcare-and-medical-concept-photo.jpg"
                  alt="hospital"
                  className="w-full h-[220px] sm:h-[280px] md:h-[340px] lg:h-[420px] object-cover"
                />
              </div>

              {/* subtle card - responsive position */}
              <motion.div
                initial={{ y: 16, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ delay: 0.12 }}
                className="absolute -bottom-6 left-4 sm:left-6 md:left-8 lg:left-10 bg-white rounded-2xl shadow-lg p-4 w-60 sm:w-64 md:w-72"
              >
      ...
      {/* WHO WE ARE / MISSION - full width with constrained inner content */}
      <section className="w-full px-6 py-16 md:py-20">
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-center px-4 sm:px-6 lg:px-8">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-[#231F53]">Who we are</h2>
          ...
          <div>
            <h3 className="text-xl sm:text-2xl font-semibold text-[#231F53]">Our Mission</h3>
            ...
            <h3 className="mt-6 text-xl sm:text-2xl font-semibold text-[#231F53]">Our Vision</h3>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
              ...
              >
                <div className="text-2xl sm:text-3xl font-extrabold text-[#231F53]">
      ...
      <section className="w-full px-6 py-16">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-[#231F53]">Our values</h2>
      ...
      <section className="w-full px-6 py-16">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-[#231F53]">Meet our experts</h2>
      ...
      {/* CTA */}
      <section className="w-full bg-indigo-600 py-12">
        <div className="w-full px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <h3 className="text-xl sm:text-2xl font-semibold text-white">Ready to get care?</h3>
